                        ...
                        <table className="table table-hover table-sm border-bottom">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span className="font-weight-bold">{dateformat(parseDate(report.date), datePattern)}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><span className="font-weight-bold">Дата</span></td>
                                    <td><span className="font-weight-bold">{report.last_data ? dateformat(parseDate(report.last_data.date), datePattern) : '---'}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><span className="font-weight-bold">Дата</span></td>
                                    <td><span className="font-weight-bold">{report.current_data ? dateformat(parseDate(report.current_data.date), datePattern) : '---'}</span></td>
                                </tr>
                                <tr>
                                    <td><span className="font-weight-bold">Показание</span></td>
